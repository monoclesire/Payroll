...
if(isset($_POST['gen_payslip'])){
    ...
    $gross_pay = $_POST['total_grosspay'];
    $net_pay = $_POST['netpay'];
    $total_deductions = $_POST['total_deduction_name'];

    $net_pay_sql = "INSERT INTO employee_salary_datas(month,position_name,worked_hours,overtime_hours,overtime_pay,holiday_pay,gross_pay,net_pay,total_deductions)
    VALUES ('$month','$position_name','$worked_hrs','$overtime_hrs','$overtime_pay','$holiday_pay','$gross_pay','$net_pay','$total_deductions')";
...
<body>
    ...
    <script>
        ...
        function resetForm() {
            ...
            document.getElementById('num_of_days').value = '';
            document.getElementById('ot_hr').value = '';
        ...
        function cancelTransaction() {
            if (confirm('Do you really want to cancel the transaction?')) {
                window.location.href = 'payroll_section.php'; // Replace 'cancel_url' with the URL you want to redirect to
            }
        }
    </script>
</body>
